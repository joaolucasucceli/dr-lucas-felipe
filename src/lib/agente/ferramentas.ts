...
export const ferramentasAgente: ChatCompletionTool[] = [
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Gera o ORÇAMENTO EXATO do paciente com Dr. Lucas. Chame assim que tiver procedimento desejado + região + foto recebida — são os ÚNICOS requisitos. NÃO colete tempo de incômodo, histórico de saúde, procedimento anterior ou principal incômodo antes de chamar: essas perguntas foram removidas do fluxo em 22/07/2026 por decisão do Dr. Lucas. NÃO peça autorização adicional — a foto já é o aceite. Esta tool só retorna ok quando a mensagem principal chegou ao Dr. Lucas; se falhar, não diga que enviou. Depois de ok, responda uma vez em dois blocos: 'Recebi, [nome]. Obrigada por enviar.' e 'Agora tenho o que o Dr. Lucas precisa pra definir o orçamento exato. Vou enviar pra ele e te retorno por aqui.' Enquanto Dr. Lucas define o valor, a Ana Júlia continua consultiva para dúvidas, mas não agenda, não promete preço e não cria novo orçamento. Sem foto não chame esta tool; nesse caso explique que o valor depende do caso e insista na foto — nunca dê média nem faixa.",
      parameters: {
        type: "object",
        properties: {
          contatoId: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Consulta os procedimentos da clínica: descrição, duração, pós-operatório, escopoOferta e parcelamento. Use para explicar o que é o procedimento e como funciona. ATENÇÃO: esta tool NÃO retorna valor, faixa nem estimativa — nenhum preço existe aqui, de propósito (decisão do Dr. Lucas em 22/07/2026). Se o paciente pediu preço, a resposta não está nesta tool: peça a foto da região, chame gerar_orcamento e o Dr. Lucas define o valor do caso. Nunca cite número a partir do retorno desta tool. Resultados visuais relacionados são enviados pelo sistema, se houver mídia válida; não prometa imagem manualmente.",
      parameters: {
        type: "object",
        properties: {
          filtro: {
