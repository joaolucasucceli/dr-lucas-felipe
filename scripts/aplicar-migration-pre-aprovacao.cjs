...
const sqlRaw = fs.readFileSync(
  path.join(__dirname, "..", "supabase", "migrations", "20260525130000_pre_aprovacao_agendamento.sql"),
  "utf8"
)
...
;(async () => {
  ...
  console.log(`Aplicando ${stmts.length} statement(s) JLU-170 v2 (pre-aprovacao)...`)
