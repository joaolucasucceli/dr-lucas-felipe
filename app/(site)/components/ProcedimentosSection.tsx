        ...
        <div className="flex flex-wrap justify-center gap-6">
          {PROCEDIMENTOS.map((proc, i) => (
            <AnimateOnScroll key={proc.titulo} delay={Math.min(i % 3, 3) as 0 | 1 | 2 | 3}>
              <div className="group w-full max-w-sm rounded-2xl border border-site-text/8 bg-white p-8 transition-all hover:border-site-gold/30 hover:shadow-lg hover:shadow-site-gold/5">
