  ...
  return (
    <div>
      ...
      <Tabs defaultValue="sobre" className="mt-6">
        <TabsList>
          <TabsTrigger value="sobre">Sobre Eduarda</TabsTrigger>
            ...
            <>
              <div className="mb-6 flex items-center justify-between">
                ...
                <div className="ml-4">
                  ...
                  >
                    {apenasDivergentes ? "Só divergentes" : "Só com divergências"}
                  </Button>
                </div>
              </div>
              ...
              {carregando && logs.length === 0 ? (
                ...
                <EmptyState
                  ...
                  descricao="A Eduarda gera logs a cada resposta da Ana Júlia."
                />
              ) : (
                          ...
                          <div className="flex flex-wrap gap-2 pt-1">
                            ...
                            {log.divergencias.length > 0 && (
                              <Badge variant="destructive" className="text-xs">
                                {log.divergencias.length} divergência(s)
                              </Badge>
                            )}
                            {log.aplicado && (
                              <Badge variant="default" className="text-xs">
          ...
          {logSelecionado && (
            <ScrollArea className="max-h-[65vh] pr-3">
              <div className="space-y-4">
                ...
                {logSelecionado.divergencias.length > 0 && (
                  <section>
                    <h3 className="mb-2 text-sm font-semibold text-orange-600">
                      Divergências ({logSelecionado.divergencias.length})
                    </h3>
                ...
                <section>
                  <h3 className="mb-2 text-sm font-semibold">
                    Histórico enviado ({logSelecionado.historicoMensagens.length}{" "}
                    mensagens)
                  </h3>
